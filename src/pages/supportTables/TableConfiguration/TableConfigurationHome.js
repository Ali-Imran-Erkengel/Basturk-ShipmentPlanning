...
import TableConfigurationAdd from './TableConfigurationAdd';
import TableConfigurationUpdate from './TableConfigurationUpdate';
import TableConfigurationView from './TableConfigurationView';
import { useNavigate } from 'react-router-dom';

function TableConfigurationAddHome() {
  ...
  const renderComponent = () => {
    switch (activeComponent) {
      case 'add':
        return <TableConfigurationAdd onBack={handleBack} />;
      case 'update':
        if (selectedItem !== '') {
          return <TableConfigurationUpdate id={selectedItem} onBack={handleBack} />;
        } else {
      ...
      case 'view':
        if (selectedItem !== '') {
          return <TableConfigurationView id={selectedItem} onBack={handleBack} />;
        }
        else {
          alert('Lütfen Satır Seçiniz');
          setActiveComponent(null);
      ...
      default:
        return (
          <div className='page-container'>
            <Header title={"Tablo Konfigürasyon Destek Tablosu"} nav='home' onBack={returnHome}></Header>
...
export default TableConfigurationAddHome