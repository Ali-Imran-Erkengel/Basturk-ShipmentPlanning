...
function ShipmentItems({dataAddAfter,nonPlannedItems}) {
    ...
    return (
        <>
            ...
            >
                ...
                <Column dataField="U_BinCode" caption="Posta Kodu" allowEditing={false}  />
                <Column dataField="U_BinEntry" caption="Posta Kodu" allowEditing={false}  />
